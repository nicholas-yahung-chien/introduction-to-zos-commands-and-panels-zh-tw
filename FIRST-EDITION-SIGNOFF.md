...
- Static learning practice converted from 5 H5P short quiz sources, 11 questions total.
...
The first-edition baseline passed release verification, subtitle presence checks, content quality checks, practice data checks, and site checks with 9 deployed videos, 11 practice questions, and 7 lab items.
